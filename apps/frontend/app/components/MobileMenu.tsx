  ...
  const authOptions = [
    {
      ...
      description: "Stream music, create playlists, and follow artists you like.",
    ...
    },
    {
      ...
      description: "Upload and sell your music, manage your profile, and use artist tools.",
    ...
    },
    {
      ...
      description: "Sell more beats, scale your business, and rise in market rankings.",
    ...
    },
    {
      ...
      description: "Sell music, earn commissions, and maximize your earnings.",
            ...
            <div className={`flex-shrink-0 p-6 bg-black`}>
              <div className="flex items-start justify-between gap-4 mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {!user && (
                    <>
                      <Link href="/auth/user/signin" className="p-2 rounded-full bg-white/10 text-white hover:bg-white/15 transition-colors" aria-label="Login">
                        <LogIn className="w-5 h-5" />
                      </Link>
                      <Link href="/auth/user/signup" className="p-2 rounded-full bg-purple-600 text-white hover:bg-purple-500 transition-colors" aria-label="Register">
