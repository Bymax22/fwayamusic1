                ...
                >
                  <div className="relative">
                    <input
                      ...
                      className="w-full max-w-none sm:max-w-lg bg-[#07202a]/60 text-white placeholder-gray-400 rounded-full pl-4 sm:pl-4 pr-12 sm:pr-4 py-7 sm:py-2 border border-[#0a3747] text-xs sm:text-base placeholder:text-xs sm:placeholder:text-base focus:outline-none focus:ring-0"
                    />
                    <button
                      type="submit"
                ...
                >
                  <div className="relative">
                    <input
                      ...
                      onBlur={() => setTimeout(() => setShowSearchResults(false), 200)}
                      placeholder="Search music..."
                      className="w-full bg-[#07202a]/60 text-white placeholder-gray-400 rounded-full pl-4 sm:pl-4 pr-12 sm:pr-4 py-7 sm:py-2 border border-[#0a3747] text-xs sm:text-base placeholder:text-xs sm:placeholder:text-base focus:outline-none focus:ring-0"
                    />
                    <button
                      type="submit"
                      disabled={!searchQuery.trim()}
