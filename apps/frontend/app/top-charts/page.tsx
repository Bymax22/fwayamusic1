    ...
    <div className="p-6 max-w-7xl mx-auto bg-gradient-to-br from-[#2E055E]/95 to-[#5B0EA6]/95 min-h-screen pb-32">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-2 bg-[#2E055E] rounded-xl p-1">
          ...
          {charts.slice(0, 3).map(track => (
            ...
            >
              ...
              <button 
                ...
                className="absolute bottom-4 right-4 w-10 h-10 bg-[#5B0EA6] hover:bg-[#9B5DE5] rounded-full flex items-center justify-center transition-colors"
              >
