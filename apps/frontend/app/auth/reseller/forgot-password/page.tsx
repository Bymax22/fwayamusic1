// app/auth/reseller/forgot-password/page.tsx
"use client";

import { useState } from 'react';
import { motion } from 'framer-motion';
import { useAuth } from '@/context/AuthContext';
import { FaStore, FaCheck, FaArrowLeft } from 'react-icons/fa';
          ...
          <div className="text-center">
            ...
            <div className="space-y-3">
              <Link
                ...
                className="w-full block px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-semibold text-center"
              >
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Enter your reseller email to receive a reset link</p>
        </div>
